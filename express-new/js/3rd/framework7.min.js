            ...
            return p.animating = !1, p.addValue = function (e) {
                ...
                for (l = 1; u >= l; l++) {
                    ...
                    for (d = 1; m >= d; d++) {
                        ...
                        var T = o.getFullYear(), k = o.getMonth() + 1;
                        w += '<div data-year="' + T + '" data-month="' + k + '" data-day="' + y + '" class="picker-calendar-day' + x + '" data-date="' + (T + "-" + k + "-" + y) + '"><div class="daysinit">' + y + "</div><div class='daysprice'></div></div>"
                    }
